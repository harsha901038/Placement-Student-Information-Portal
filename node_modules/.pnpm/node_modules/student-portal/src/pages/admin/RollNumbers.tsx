...
export default function AdminRollNumbers() {
  ...
  useEffect(() => {
  fetch("https://placement-student-information-portal.onrender.com/api/admin/rolls-by-branch")
    .then(res => res.json())
  ...
  const handleUpload = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://placement-student-information-portal.onrender.com/api/admin/roll-numbers", {
        method: "POST",
...
const res2 = await fetch("https://placement-student-information-portal.onrender.com/api/admin/rolls-by-branch");

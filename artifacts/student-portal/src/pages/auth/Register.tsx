    ...
    <div className="min-h-screen flex w-full bg-gray-50">
      <div className="flex-1 flex items-center justify-center p-8 sm:p-12 relative z-10">
        ...
        >
          ...
          <h1 className="text-3xl font-display font-bold text-center text-gray-900 mb-2">Create Account</h1>
          <p className="text-center text-gray-500 mb-8">Join the student placement portal</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button 
              type="submit" 
              className="w-full rounded-xl py-6 text-lg font-semibold shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all mt-4"
      ...
      <div className="hidden lg:flex flex-1 relative bg-primary">
        ...
        <div className="relative z-20 flex flex-col justify-center px-16 text-white max-w-2xl">
          <h2 className="text-5xl font-display font-bold leading-tight mb-6">Your Future Starts Here</h2>
